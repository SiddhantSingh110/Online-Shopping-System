...
<table width="366" border="0" align="center">
  ...
  <tr>
    <td><div align="left"><strong><font size="+1" face="Comic Sans MS">Title:</font></strong></div></td>
    <td><label>
  ...
  <tr>
    <td width="164"><div align="left"><font size="+1" face="Comic Sans MS"><b> First&nbsp;Name:</b></font></div></td>
    <td width="192">
      
        <input name="t1" type="text" id="t1" onChange="return fnam()">    </td>
  </tr>
  <tr>
    <td><div align="left"><font size="+1" face="Comic Sans MS"><strong>Last name:</strong></font></div></td>
  ...
  <tr>
    <td><div align="left"><font size="+1" face="Comic Sans MS"><b>Enter Email : </b></font></div></td>
    <td><input name="t3" type="text" id="t3" onChange="return email()"></td>
  </tr>
  <tr>
    <td><div align="left"><font size="+1" face="Comic Sans MS"><b>Choose a  Password:</b> </font></div></td>
    <td><input name="p1" type="password" id="p1" onChange="return pass()"></td>
  </tr>
  <tr> <td><div align="left"><font size="+1" face="Comic Sans MS"><b>Phone no: </b></font></div></td>
    <td><input name="t5" type="text" id="t5" onChange="return phone()" min="1" max="10"></td>
  </tr>
  <tr>
    <td><div align="left"><font size="+1" face="Comic Sans MS"><strong>Address:</strong></font></div></td>
    <td><label>
      <textarea name="t6" id="t6" value="return add()"></textarea>
    </label></td>
  </tr>
  <tr>
    <td><div align="left"><font size="+1" face="Comic Sans MS"><strong>City:</strong></font></div></td>
    <td><input name="t7" type="text" id="t7" onChange="return city()"></td>
  </tr>
  <tr>
    <td><div align="left"><font size="+1" face="Comic Sans MS"><strong>Country:</strong></font></div></td>
    <td><input name="t8" type="text" id="t8" onChange="return coun()"></td>
  </tr>
  <tr>
    <td><div align="left"><strong><font size="+1" face="Comic Sans MS">Date of Birth: </font></strong></div></td>
    <td><label>
